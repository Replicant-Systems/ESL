...

{
  if (WiFi.status() == WL_CONNECTED) {
    ...
    while (redirecting) {
      ...
      //http.setTimeout(15000);  // Increase timeout if needed
      ...
      else 
      {
        ...
        if (httpCode > 0) 
        {
          ...
          // Example: "1234,5678,9101,1121,3141,5161,7181,9201"
          int data[8];
          int index = 0;
